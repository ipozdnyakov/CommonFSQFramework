...
dsFile="CommonFSQFramework/Skim/python/ds_Decorr2015_76.txt"
...
def json(ds):
    realData = isData(ds)
    if realData:
        if "Run2015" in ds: return "CommonFSQFramework/Skim/lumi/Cert_254986-255031_13TeV_PromptReco_Collisions15_LOWPU_25ns_JSON.txt"
    else:
        return ""
