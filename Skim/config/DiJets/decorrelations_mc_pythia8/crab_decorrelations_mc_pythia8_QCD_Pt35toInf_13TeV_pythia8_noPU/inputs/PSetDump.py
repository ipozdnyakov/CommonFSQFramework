...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/mc/RunIIFall15MiniAODv2/MinBias_TuneCUETHS1-13TeV-herwigpp/MINIAODSIM/noPU_castor_76X_mcRun2_asymptotic_v12-v1/100000/0006DB23-C0E8-E611-A12A-008CFA197DC4.root')
)
process.XS = cms.EDProducer("DoubleProducer",
    provHack = cms.string('\n################################################################################\nAna version: decorrelations_mc_pythia8\nXS = -1\nisData = False\n################################################################################\n'),
    value = cms.double(-1)
)
...
process.schedule = cms.Schedule(*[ process.pUtil, process.pJetTree, process.pTreeProducers ])
